...
/* Знак Eva Space — как иконка приложения и «Книга стандартов»: белая
   ...
   свечением. Один рисунок с CRM — чтобы штаб и CRM узнавались как одно. */
...
function brandIcon(cls = '') {
  ...
  return `<svg viewBox="0 0 100 100" class="${cls}" aria-hidden="true">
    ...
    <g fill="#fff" opacity=".85"><path d="M78 22c.4 4 1.1 6.7 2.2 8.2 1.1 1.5 3.6 2.5 7.6 3.1-4 .6-6.5 1.5-7.6 3.1-1.1 1.5-1.8 4.6-2.2 9.2-.4-4.6-1.1-7.7-2.2-9.2-1.1-1.6-3.6-2.5-7.6-3.1 4-.6 6.5-1.6 7.6-3.1 1.1-1.5 1.8-4.2 2.2-8.2z" transform="scale(.55) translate(63 62)"/><path d="M22 68c.3 3 .8 5 1.6 6.1.8 1.1 2.7 1.9 5.7 2.3-3 .5-4.9 1.2-5.7 2.3-.8 1.2-1.3 3.5-1.6 6.9-.3-3.4-.8-5.7-1.6-6.9-.8-1.1-2.7-1.8-5.7-2.3 3-.4 4.9-1.2 5.7-2.3.8-1.1 1.3-3.1 1.6-6.1z" transform="scale(.72) translate(6 8)"/></g>
  </svg>`;
}

...
const View = {
  _s: null,
  get(k, def) { if (!this._s) this._s = Local.get('eva-crm-view', {}); return k in this._s ? this._s[k] : def; },
  set(k, v) { if (!this._s) this._s = Local.get('eva-crm-view', {}); this._s[k] = v; Local.set('eva-crm-view', this._s); },
};

...
function withdraw(sum){
  ...
  if(typeof platformSay === 'function')
    platformSay('Заявка на вывод ' + money(sum) + ' принята. Реквизиты — карту или счёт — пришли ответом на это письмо. ' +
      'Переводим в течение трёх рабочих дней и напишем сюда, когда отправили.',
      '', 'space', tk.id);

...
export const REGIONS = {
  dubai: {
    name: 'Дубай', country: 'ОАЭ', flag: '🇦🇪', lat: 25.2, lon: 55.27, tz: 'GMT+4', currency: 'AED',
  ...
  bali: {
    name: 'Бали', country: 'Индонезия', flag: '🇮🇩', lat: -8.65, lon: 115.13, tz: 'GMT+8', currency: 'IDR',
  ...
  moscow: {
    name: 'Москва', country: 'Россия', flag: '🇷🇺', lat: 55.75, lon: 37.62, tz: 'GMT+3', currency: 'RUB',
  ...
  phuket: {
    name: 'Пхукет', country: 'Таиланд', flag: '🇹🇭', lat: 7.89, lon: 98.3, tz: 'GMT+7', currency: 'THB',
  ...
  istanbul: {
    name: 'Стамбул', country: 'Турция', flag: '🇹🇷', lat: 41.01, lon: 28.98, tz: 'GMT+3', currency: 'TRY',
  ...
  tbilisi: {
    name: 'Тбилиси', country: 'Грузия', flag: '🇬🇪', lat: 41.72, lon: 44.78, tz: 'GMT+4', currency: 'GEL',
  ...
  yerevan: {
    name: 'Ереван', country: 'Армения', flag: '🇦🇲', lat: 40.18, lon: 44.51, tz: 'GMT+4', currency: 'AMD',
  ...
  almaty: {
    name: 'Алматы', country: 'Казахстан', flag: '🇰🇿', lat: 43.24, lon: 76.89, tz: 'GMT+5', currency: 'KZT',
  ...
  belgrade: {
    name: 'Белград', country: 'Сербия', flag: '🇷🇸', lat: 44.79, lon: 20.45, tz: 'GMT+2', currency: 'RSD',
  ...
  lisbon: {
    name: 'Лиссабон', country: 'Португалия', flag: '🇵🇹', lat: 38.72, lon: -9.14, tz: 'GMT+1', currency: 'EUR',
  ...
  barcelona: {
    name: 'Барселона', country: 'Испания', flag: '🇪🇸', lat: 41.39, lon: 2.17, tz: 'GMT+2', currency: 'EUR',
  ...
  london: {
    name: 'Лондон', country: 'Британия', flag: '🇬🇧', lat: 51.51, lon: -0.13, tz: 'GMT+1', currency: 'GBP',
  ...
  newyork: {
    name: 'Нью-Йорк', country: 'США', flag: '🇺🇸', lat: 40.71, lon: -74.01, tz: 'GMT-4', currency: 'USD',
  ...
  miami: {
    name: 'Майами', country: 'США', flag: '🇺🇸', lat: 25.76, lon: -80.19, tz: 'GMT-4', currency: 'USD',
  ...
  mexico: {
    name: 'Мехико', country: 'Мексика', flag: '🇲🇽', lat: 19.43, lon: -99.13, tz: 'GMT-6', currency: 'MXN',
  ...
  saopaulo: {
    name: 'Сан-Паулу', country: 'Бразилия', flag: '🇧🇷', lat: -23.55, lon: -46.63, tz: 'GMT-3', currency: 'BRL',
  ...
  capetown: {
    name: 'Кейптаун', country: 'ЮАР', flag: '🇿🇦', lat: -33.92, lon: 18.42, tz: 'GMT+2', currency: 'ZAR',
  ...
  bangkok: {
    name: 'Бангкок', country: 'Таиланд', flag: '🇹🇭', lat: 13.76, lon: 100.5, tz: 'GMT+7', currency: 'THB',
  ...
  singapore: {
    name: 'Сингапур', country: 'Сингапур', flag: '🇸🇬', lat: 1.35, lon: 103.82, tz: 'GMT+8', currency: 'SGD',
  ...
  tokyo: {
    name: 'Токио', country: 'Япония', flag: '🇯🇵', lat: 35.68, lon: 139.65, tz: 'GMT+9', currency: 'JPY',
